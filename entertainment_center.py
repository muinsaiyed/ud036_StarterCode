...
good_will_hunting = media.Movie("Good Will Hunting",
                                "A janitor at M.I.T., has a gift for math, "
                                "but needs help from a psychologist "
...
fight_club = media.Movie("Fight Club",
                         "An underground club that evolves into"
...
shawshank = media.Movie("Shawshank Redemption",
                        "2 imprisoned men bond over a number of years.",
...
dark_knight = media.Movie("The Dark Knight",
                          "Batman must accept one of the "
                          "greatest psychological and physical tests of "
...
raid = media.Movie("The Raid Redepmtion",
                   "A S.W.A.T. team becomes trapped in a tenement run"
                   "by a ruthless mobster and his army of killers and thugs.",
...
movies = [good_will_hunting, fight_club, shawshank,
          stand_by_me, dark_knight, raid]

# Passing the movie array into a function written in the fresh_tomatoes
# file which will open the website and load all of our movies
